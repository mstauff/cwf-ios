...
extension Calling : Equatable {
    ...
    static public func == (lhs : Calling, rhs : Calling ) -> Bool {
        ...
        if lhs.parentOrg == rhs.parentOrg  {
            ...
            } else if lhs.position.custom && rhs.position.custom {
                // they could still be == if they are a custom position
                result = (lhs.cwfId != nil && lhs.cwfId == rhs.cwfId) 
            }
        }
